...
# echo -e "${BBlue}This is BASH ${BRed}${BASH_VERSION%.*}${BBlue}\
# - DISPLAY on ${BRed}$DISPLAY${ColorReset}\n"
# date
...
# {
#     echo -e "${BRed}Hasta la vista, baby${ColorReset}"
# }
# trap _exit EXIT
...
#    Cyan      == less than 10% free disk space
#    ALERT     == less than 5% free disk space
#    Red       == current user does not have write privileges
#    Blue      == current filesystem is size zero (like /proc)
# >:
#    White     == no background or suspended jobs in this shell
#    Blue      == at least one background job in this shell
#    Cyan    == at least one suspended job in this shell
#
...
function create_prompt()
{
    ...
    then
        ...
        #   paste properly
        let fillLeft=(${fillSize}/2)-1
        let fillRight=${fillSize}-${fillLeft}
...
export HISTTIMEFORMAT="$(echo -e ${BBlue})[%d/%m %H:%M:%S]$(echo -e ${ColorReset}) "
export HISTCONTROL=ignoredups:erasedups
export HISTIGNORE="&:bg:fg:ll:h:cd:ls"
...
function ii()   # Get current host related info.
{
    ...
    echo -e "\n${BRed}Additionnal information:$ColorReset " ; uname -a
    echo -e "\n${BRed}Users logged on:$ColorReset " ; w -hs |
    cut -d " " -f1 | sort | uniq
    echo -e "\n${BRed}Current date :$ColorReset " ; date
    echo -e "\n${BRed}Machine stats :$ColorReset " ; uptime
    echo -e "\n${BRed}Memory stats :$ColorReset " ; free
    echo -e "\n${BRed}Diskspace :$ColorReset " ; mydf / $HOME
    echo -e "\n${BRed}Local IP Address :$ColorReset" ; my_ip
    echo -e "\n${BRed}Open connections :$ColorReset "; netstat -pan --inet;
    echo
}
